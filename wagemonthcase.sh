#!/bin/bash
        ...
        monthly_employee_wage_part=$(($Daily_employee_wage_part*20))
        ...
        case $ch in
            ...
            2)echo "Daily Employee Wage Full Time - "$Daily_employee_wage_part;;


            3)echo "monthly_employee_wage_full - "$monthly_employee_wage_full;;
            4)echo "monthly_employee_wage_part - "$monthly_employee_wage_full;;
        esac
